...
<body>
        ...
        <div class="center container py-4 ">
            ...
            <form class="contact-form row" method="post" role="form">
                ...
                <div class="col-lg-2">
                    <h4>End date</h4>
                    <div>
                        <input type="Date" id="Today" class="form-control form-control-lg light-300" name="EDate">
                    </div>
                </div>
    ...
    if (isset($_POST['Week'])) {
        ...
        $dates = createRange($_POST['ASDayDate'], $_POST['AEDate']);
        $Cid = $_POST['View'];
        ...
        if ($Cid == "All") {
            ...
            ?>
                <div class="overview shadow-sm rounded-top rounded-3 py-sm-0 outputResults" id="outputResults">
                    <div class="pl-3 pt-2">
                        <h3 class="semi-bold-600 text-center mt-2">Results for: <?php echo $_POST['ASDayDate'] . "-" . $_POST['AEDate'] ?></h3>
                        <br>
                        <div class="col-md-12 col-12 m-auto text-end">
                            <div class="row">
                                <div class="col-md-4 col-xl-3">
    ...
    if (isset($_POST['Month'])) {
        ...
        $dates = createRange($_POST['ASMonthDate'], $_POST['AEDate']);
        $Cid = $_POST['View'];
        ...
        if ($Cid == "All") {
            ...
            ?>
                <div class="overview shadow-sm rounded-top rounded-3 py-sm-0 outputResults" id="outputResults">
                    <div class="pl-3 pt-2">
                        <h3 class="semi-bold-600 text-center mt-2">Results for: <?php echo $_POST['ASMonthDate'] . "-" . $_POST['AEDate'] ?></h3>
                        <br>
                        <div class="col-md-12 col-12 m-auto text-end">
                            <div class="row">
                                <div class="col-md-4 col-xl-3">
...
<script type="text/javascript">
    function SetDate() {
        ...
        document.getElementById("Today").dateControl.value = "<?php echo date("Y-M-D") ?>";
        document.getElementById("LastM").value = <?php echo date("Y-m-d", strtotime('-1 months', strtotime($EDate))) ?>;
