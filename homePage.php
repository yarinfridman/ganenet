                ...
                <div class="container">
                    <div class="row d-flex align-items-center py-5">
                        <div class="col-lg-6 text-start">
                            <h1 class="h2 py-5 text-primary typo-space-line">GaneNet</h1>
                            <p class="light-300">
                ...
                <div class="container">
                    ...
                    <div class="row gy-5 g-lg-5 mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="childrenList.html" class="recent-work card border-0 shadow-lg overflow-hidden">
                        ...
                        <!-- Start Recent Work -->
                        <div class="col-md-4 mb-3">
                            <a href="events.html" class="recent-work card border-0 shadow-lg overflow-hidden">
